...
export const translations = {
  en: {
    ...
    'realm.technical.desc': 'Structured notes and research experiments around symbolic systems and computation.',
  ...
  hi: {
    ...
    'realm.technical.desc': 'प्रतीकात्मक प्रणालियों और कम्प्यूटेशन पर संरचित नोट्स तथा शोध-प्रयोग।',
